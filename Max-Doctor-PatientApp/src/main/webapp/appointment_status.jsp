...
<%@page import="com.motivity.Hospital.repositorys.AppointmentsRepo"%>
<%@page import="com.motivity.Hospital.models.Appointments"%>
<%@page import="com.motivity.Hospital.models.Patients"%>
...
<div class="wrapper">
        ...
        <div>
            ...
            <ul>
                ...
                <li>
                    <a href="appointment_status.jsp"  class="active">
    ...
    <thead class="bg-primary text-lime">
      <tr>
        ...
        <th scope="col">DR_GENDER</th>
        <th scope="col">DR_PHNO</th>
    ...
    <%
	AppointmentsRepo apr=(AppointmentsRepo)session.getAttribute("appointmentsrepo");
	List<Appointments> applist=apr.patientsidestatus(Integer.toString(pd.getPatientId()));
	for(Appointments aa:applist)
	{
		%>
		<tr>
		<td><%=aa.getAppointmentId() %></td>
		<td><%=aa.getPatientId() %></td>
		<td><%=aa.getProblem() %></td>
		<td><%=aa.getDoctorName() %></td>
		<td><%=aa.getDoctorGender() %></td>
		<td><%=aa.getDoctorPhoneNo() %></td>
		<td><%=aa.getAppointmentDate() %></td>
		<td><%=aa.getTime() %></td>
		<td><%=aa.getStatus() %></td>
		</tr>
		<%} %>
